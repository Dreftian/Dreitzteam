...
const APP_TITLE = 'DREITZ';
const APP_SUBTITLE = 'DREITZTEAM';
const APP_TAGLINE = 'Tu nueva forma de jugar';
...
function headerBackground() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 228" width="600" height="228">
    ...
    <text x="230" y="122" font-family="Segoe UI, Inter, sans-serif" font-weight="900" font-size="78" fill="url(#text)" letter-spacing="-2">${APP_TITLE}</text>
    <text x="234" y="164" font-family="Segoe UI, Inter, sans-serif" font-weight="700" font-size="20" fill="#a79d91" letter-spacing="6">${APP_SUBTITLE}</text>
  </svg>`;
}
...
function sidebarBackground() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 656 1256" width="656" height="1256">
    ...
    <text x="328" y="930" text-anchor="middle" font-family="Segoe UI, Inter, sans-serif" font-weight="900" font-size="118" fill="url(#text)" letter-spacing="-3">${APP_TITLE}</text>
...
console.log('Generating installer art from tian logo...');
...
console.log('Installer art ready.');
